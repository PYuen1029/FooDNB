...
class FoodItemsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // create some records
        $wheatBread = User::whereName('StephenHarper')->first()->foodItems()->create(array(
        ...
        $watermelon = User::whereName('Modi')->first()->foodItems()->create(array(
        	'name' => 'Watermelon',
        ...
        $redPepper = User::whereName('ShinzoAbe')->first()->foodItems()->create(array(
        	'name' => 'Red Pepper',
        ...
        $squash = User::whereName('XiJinPing')->first()->foodItems()->create(array(
            'name' => 'Squash',
            'day_id' => App\Day::where('activate_time','2015-09-21 07:00:00')->first()->id,
            'quantity' => 2,
            'claimed' => 1
